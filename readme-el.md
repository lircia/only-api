...
- Η εγγραφή με επαλήθευση email χρησιμοποιεί 13ψήφιο αριθμητικό κωδικό, ισχύει για 13 λεπτά, επιτρέπει 3 προσπάθειες και επαναποστολή μετά από 67 δευτερόλεπτα.
- Η επαλήθευση κατάληξης email και η υποχρεωτική αριθμητική πρόθεση QQ email αλλάζουν από τις ρυθμίσεις συστήματος και είναι ενεργές από προεπιλογή.
...
## Επαλήθευση email κατά την εγγραφή

Όταν η επαλήθευση email είναι ενεργή, η εγγραφή δεν στέλνει πλέον σύνδεσμο. Στέλνει 13ψήφιο αριθμητικό κωδικό με email.

- Ο κωδικός ισχύει για 13 λεπτά.
- Κάθε κωδικός επιτρέπει 3 προσπάθειες εισαγωγής.
- Η σελίδα εισαγωγής κωδικού έχει κουμπί επαναποστολής.
- Η επαναποστολή έχει αναμονή 67 δευτερολέπτων.
- Η φόρμα εγγραφής έχει πεδίο επιβεβαίωσης κωδικού πρόσβασης.
- Η επαλήθευση κατάληξης email είναι ενεργή από προεπιλογή και υποστηρίζει γνωστούς παρόχους όπως `qq.com`, `163.com`, `gmail.com`, `outlook.com`, `yeah.net`, `hotmail.com` και `126.com`.
- Τα email `qq.com` απαιτούν από προεπιλογή καθαρά αριθμητική πρόθεση QQ.
- Ο διαχειριστής μπορεί να απενεργοποιήσει την επαλήθευση κατάληξης ή την απαίτηση αριθμητικής πρόθεσης QQ από τις ρυθμίσεις συστήματος.
